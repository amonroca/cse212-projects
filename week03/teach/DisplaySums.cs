public static class DisplaySums
{
    ...
    private static void DisplaySumPairs(int[] numbers)
    {
        ...
        var usedPairs = new HashSet<int>();

        foreach (var num in numbers)
        {
            var complement = 10 - num;

            // Check if the complement exists and we haven't used this pair yet
            if (seen.Contains(complement) && !usedPairs.Contains(num) && !usedPairs.Contains(complement))
            {
