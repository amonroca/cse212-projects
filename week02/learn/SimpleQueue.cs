public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: Dequeue method is retirning IndexOutOfRangeException
        // because it is trying to access an index that does not exist in the list.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue method is not working correctly.
        // It is not adding the values to the queue in the correct order.
        ...
        // Defect(s) Found: No defect found. The exception is raised as expected.
    }
