...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: AreEqual failed. Expected Bob but was Sue.
    ...
    // Defect(s) Found: AreEqual failed. Expected Tim but was Bob.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: AreEqual failed. Expected Tim but was Sue.
    ...
    // Defect(s) Found: No defect. Exception was thrown as expected.
